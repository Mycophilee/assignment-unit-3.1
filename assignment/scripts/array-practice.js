...
let favoriteFoods = ['mangos','tofu','pickles'];
...
console.log('Added desert to end,', favoriteFoods);
...
console.log('Entre is now', favoriteFoods);
...
console.log('The first color is now', colors);
